...
Flolder **clevr** contains scripts for rendering our scene jsons as generated by CLEVR scripts. It is originally forked from official repository, so it contains some question generation scripts as well.
