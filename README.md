...
Folder **clevr** contains scripts for rendering our scene jsons as generated by CLEVR scripts. It is originally forked from official repository, so it contains some question generation scripts as well.

### 2d

Folder **2d** contains box2d executables to render simulations in 2-dimensional environments.

box2d provides 2-dimensional physics engine for our simulations. To draw simulated objects we extended it and add the following classes to be derived from their counterparts in box2d.
