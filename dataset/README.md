...
| Task  |  Category |
|---|---|
| 1. "What color is the object the **Z** **C** **S** first collides with?", "What color is the first object that collided with the **Z** **C** **S**?", "What is the color of object the **Z** **C** **S** first collides with?", "What is the color of first object that collided with the **Z** **C** **S**?" | Descriptive |
| 2. "What shape is the object the **Z** **C** **S** first collides with?", "What shape is the first object that collided with the **Z** **C** **S**?", "What is the shape of object the **Z** **C** **S** first collides with?", "What is the shape of first object that collided with the **Z** **C** **S**?" | Descriptive |
| 3. "What color is the object the **Z** **C** **S** last collides with?", "What color is the last object that collided with the **Z** **C** **S**?", "What is the color of object the **Z** **C** **S** last collides with?", "What is the color of last object that collided with the **Z** **C** **S**?" | Descriptive |
| 4. "What shape is the object the **Z** **C** **S** last collides with?", "What shape is the last object that collided with the **Z** **C** **S**?", "What is the shape of object the **Z** **C** **S** last collides with?", "What is the shape of last object that collided with the **Z** **C** **S**?" | Descriptive |
...
| 39. "Will the **Z2** **C2** **S2** **enter** the **basket**, if the **Z** **C** **S** is removed?", "If the **Z** **C** **S** is removed, will the **Z2** **C2** **S2** **enter** the **basket**?" | Counterfactual |
| 40. "Will the **Z2** **C2** **S2** **fall to** the **ground**, if the **Z** **C** **S** is removed?", "If the **Z** **C** **S** is removed, will the **Z2** **C2** **S2** **fall to** the **ground**?" | Counterfactual |
| 41. "Will the **Z2** **C2** **S2** collide with the **basket**, if the **Z** **C** **S** is removed?", "If the **Z** **C** **S** is removed, will the **Z2** **C2** **S2** collide with the **basket**?" | Counterfactual |
...
| 45. "Will the **Z** **C** **S** **enter** the **basket**, if any of the other objects are removed?", "If any of the other objects are removed, will the **Z** **C** **S** **enter** the **basket**?" | Counterfactual |
| 46. "Will the **Z** **C** **S** **fall to** the **ground**, if any of the other objects are removed?", "If any of other the objects are removed, will the **Z** **C** **S** **fall to** the **ground**?" | Counterfactual |
| 47. "Will the **Z** **C** **S** collide with the **basket**, if any of the other objects are removed?", "If any of the other objects are removed, will the **Z** **C** **S** collide with the **basket**?" | Counterfactual |
...
| 54. "Does the **Z** **C** **S** **cause** the **Z2** **C2** **S2** to **fall to** the **ground**?", "Does the **Z** **C** **S** **cause** the collision between the **Z2** **C2** **S2** and the **ground**?", "There is a **Z** **C** **S**, does it **cause** the **Z2** **C2** **S2** to **fall to** the **ground**?",       "Does the **Z** **C** **S** lead to the collision between the **Z2** **C2** **S2** and the **ground**?", "Does the **Z** **C** **S** lead to the **Z2** **C2** **S2** **falling to** the **ground**?" | Cause |
| 55. "Does the **Z** **C** **S** **cause** the **Z2** **C2** **S2** to **enter** the **basket**?", "There is a **Z** **C** **S**, does it **cause** the **Z2** **C2** **S2** to **enter** the **basket**?", "Does the **Z** **C** **S** lead to the **Z2** **C2** **S2** **entering** the **basket**?" | Cause |
| 56. "Does the **Z** **C** **S** **cause** the **Z2** **C2** **S2** to collide with the **basket**?", "Does the **Z** **C** **S** **cause** the collision between the **Z2** **C2** **S2** and the **basket**?", "There is a **Z** **C** **S**, does it **cause** the **Z2** **C2** **S2** to collide with the **basket**?", "Does the **Z** **C** **S** lead to the collision between the **Z2** **C2** **S2** and the **basket**?", "Does the **Z** **C** **S** lead to the **Z2** **C2** **S2** colliding with the **basket**?" | Cause |
