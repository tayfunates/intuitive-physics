...
|"Is there any other object which enables the big red circle to enter the basket?"|"false"|![](/dataset/examples/ExampleScene3.gif)| <table> <tbody>  <tr>  <td>![](/dataset/examples/ExampleScene3Variation1.gif)</td>  <td>![](/dataset/examples/ExampleScene3Variation2.gif)</td>  </tr>  <tr>  <td>![](/dataset/examples/ExampleScene3Variation3.gif)</td>  <td>![](/dataset/examples/ExampleScene3Variation4.gif)</td>  </tr>  <tr>  </tbody>  </table> |
